  ...
  return (
    <>
      <section className="relative overflow-hidden">
        ...
        <div className="content-grid relative grid min-h-[calc(100vh-72px)] items-center py-20 lg:grid-cols-[1.15fr_0.85fr] lg:py-28">
          <Reveal>
            <div className="max-w-3xl">
              <span className="section-kicker">International Conference 2026</span>
              <h1 className="mt-6 font-display text-6xl leading-[0.88] text-white sm:text-7xl lg:text-[7rem]">
                {siteMeta.conferenceName}
              </h1>
              <p className="mt-5 text-lg font-semibold tracking-[0.18em] uppercase text-teal-200 sm:text-xl">
                {siteMeta.subtitle}
              </p>
              <p className="mt-7 max-w-2xl text-lg leading-9 text-slate-200/86 sm:text-[1.18rem]">{siteMeta.theme}</p>
              <p className="mt-5 max-w-2xl text-lg italic text-slate-300/82">{siteMeta.tagline}</p>
              ...
              <div className="mt-9 flex flex-wrap gap-4">
                ...
                <Link to="/themes-schedule" className="button-secondary">
                  View Themes
                </Link>
              </div>

              <div className="mt-10 max-w-2xl rounded-[28px] border border-white/12 bg-white/6 p-5 text-sm leading-8 text-slate-200/78 backdrop-blur-xl">
          ...
          <Reveal delay={0.12}>
            <div className="glass-panel mt-10 overflow-hidden p-6 text-white lg:mt-0">
              ...
              <div className="mt-5 rounded-[24px] border border-white/10 bg-gradient-to-br from-white/10 to-white/4 p-5">
                ...
                <h2 className="mt-4 font-display text-4xl text-white">Research-first journey.</h2>
      ...
      <section className="pb-8">
        <div className="content-grid">
          <Reveal>
            <div className="relative overflow-hidden rounded-[36px] bg-navy-900 px-8 py-12 text-white shadow-[0_28px_80px_rgba(10,25,47,0.28)] lg:flex lg:items-center lg:justify-between lg:px-12">
              ...
              <div className="max-w-3xl">
                ...
                <h2 className="mt-6 font-display text-4xl leading-[0.95] sm:text-5xl lg:text-6xl">Don't Miss This Opportunity</h2>
              ...
              <Link to="/submit-paper" className="button-primary mt-8 lg:mt-0">
