...
export const committee = {
  ...
  patrons: [
    "Hon'ble Mrs. Sharayu Deshmukh - Managing Trustee, ASSVS",
    'Shri. Anil B. Shinde - Chief Executive Officer, ASSVS',
    'Dr. Jyotiba B. Gurav - Director Academics, ASSVS',
    'Prof. V. B. Dhumal - Manager, ASSVS',
  ],
  conferenceChair: 'Dr. M. A. Venkatesh - Principal, AVCOE',
  conferenceSecretary: 'Dr. S. B. Kandekar - Head, Department of Civil Engineering, AVCOE',
  conveners: [
    'Dr. A. J. Mehetre - Department of Civil Engineering, AVCOE',
    'Dr. R. T. Sahu - Department of Civil Engineering, AVCOE',
  ],
  organizingCommittee: [
    'Dr. A. V. Navale',
    'Dr. R. S. Ingole',
  ...
  advisoryCommittee: [
    ...
    'Dr. A. S. Sayyad - Professor, Sanjivani College of Engineering, Kopargaon',
    'Dr. Ramakant Jha - Professor, NIT Patna',
    'Dr. Samir Bajpai - Professor, NIT Raipur',
    'Dr. N. U. Mate - Professor, MIT Alandi, Pune',
    ...
    'Dr. R. S. Talikoti - Professor, R. H. Sapat College of Engineering, Nashik',
    'Dr. Mani kant Verma - Associate Professor, NIT Raipur',
